...
class Antlr4Native::Context
  include ::Antlr4Native::StringHelpers
  def class_wrapper(module_var); end

  def conversions(); end

  def cpp_parser_source(); end

  def each_context_method(); end

  def each_token_method(); end

  def initialize(name, parser_ns, cpp_parser_source); end

  def method_signatures_for(mtds); end

  def name(); end

  def parser_ns(); end

  def proxy_class_context_methods(); end

  def proxy_class_header(); end

  def proxy_class_methods(); end

  def proxy_class_token_methods(); end

  def proxy_class_variable(); end
end
...
class Antlr4Native::ContextMethod
  ...
  def context_method?(); end

  def cpp_name(); end

  def initialize(name, raw_args, return_type, context); end
  ...
  def returns_vector?(); end

  def rule_method?(); end

  def token_method?(); end
  META_METHODS = ::T.let(nil, ::T.untyped)
  RULE_METHODS = ::T.let(nil, ::T.untyped)
end

class Antlr4Native::ContextMethod
end

class Antlr4Native::ContextMethodArg
  def initialize(raw_arg); end
...
class Antlr4Native::Generator
  ...
  def grammar_files(); end

  def initialize(grammar_files:, output_dir:, parser_root_method:); end
  ...
  def parser_root_method(); end
  ANTLR_JAR = ::T.let(nil, ::T.untyped)
  ANTLR_VERSION = ::T.let(nil, ::T.untyped)
end
...
module Antlr4Native::StringHelpers
  extend ::Antlr4Native::StringHelpers
end
...
class Antlr4Native::VisitorGenerator
  ...
  def cpp_class_name(); end

  def each_visitor_method(); end

  def initialize(visitor_methods, antlr_ns, parser_ns); end

  def parser_ns(); end

  def visitor_methods(); end

  def visitor_proxy(); end

  def visitor_proxy_methods(indent); end
  VISITOR_METHOD_BLACKLIST = ::T.let(nil, ::T.untyped)
end
